<template>
    <div>
        ...
        <div class="bg">
            <div class="dim"><p STYLE="font-size:44px;font-weight: bolder;line-height: 110px;letter-spacing:10px;">热门动漫</p><p STYLE="font-size:16px;letter-spacing:4px;">POPULAR ANIME</p></div>
        </div>
        <Navbar></Navbar>
        <div class="main">
