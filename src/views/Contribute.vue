<template>
  <div class="bg">
    ...
    <div class="hd">
      <div class="dim"><p STYLE="font-size:44px;font-weight: bolder;line-height: 90px;letter-spacing:10px;">投稿</p>
        <p STYLE="font-size:16px;letter-spacing:4px;">CONTRIBUTE</p></div>
    </div>
    <div style="width:100%;margin-top: 30px">
      <div class="title">请输入视频标题：
        <el-input v-model="form.name" style="width: 25%;margin-bottom: 30px"></el-input>
      </div>
      <div class="title">
        请输入视频分区：
  ...
  export default {
    ...
    methods: {
      ...
      handleSuccess(res, file, fileList) {
        ...
        alert("上传成功，即将跳转到视频页");
        window.location.href="/VideoPage?id=" + res;
      },
    }
  }
</script>
