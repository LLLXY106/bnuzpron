    ...
    <div class="main_body">
      ...
      <div class="login_body">
        <div class="login_form">
          <div class="name">手机/昵称/邮箱<input type="text" class="userName" id="userName" placeholder="用户名"
                                           v-model="userName"></div>
          <!--<span>{{userName}}</span>-->
          <div class="pwd">请输入密码<input type="password" class="passWord" id="passWord" placeholder="密码"
                                       v-model="password"></div>
          <!--<span>{{password}}</span>-->
          <span class="forget">忘记密码?</span>
          <div class="btn"><input type="button" class="login_btn" @click="login" round :loading="isBtnLoading"
                                  value="登录 "></div>
          <div class="icon">
          ...
          <div class="registered"><a href="/registerPage" style="font-size: 14px;color:palevioletred;margin-left:260px">还没有账号?立即注册</a>
          </div>
        </div>
